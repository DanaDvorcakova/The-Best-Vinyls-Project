...
# Remove old DB if you want to start fresh (optional)
...
if c.fetchone()[0] == 0:
    sample_records = [
        ...
        # JAZZ
        ("Blue Train", "John Coltrane", 33.99, "images/JohnC_BT.jpg", "Blue Train is a 1957 album by John Coltrane considered a hard bop landmark.", "Jazz"),
    ]
